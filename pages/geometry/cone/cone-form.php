...
<body>
    ...
    <div class="title">
        <p class="main-title">Cone</p>
        <p class="sub-title">preencha as medidas do cone e calcule seu volume</p>
    </div>
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST" ){
        ...
        echo "<p>O volume do cone é: " . $volume . " unidades cúbicas </p>";
        echo "</div>";
    }
?>
